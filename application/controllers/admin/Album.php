	...
	function simpan_album(){
	            ...
	            if(!empty($_FILES['filefoto']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_album->simpan_album($user_id,$user_nama,$gambar);
	...
	function update_album(){
	            ...
	            if(!empty($_FILES['filefoto']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_album->update_album($album_id,$user_id,$user_nama,$gambar);
	                    ...
	                    redirect('admin/album');
							...
							$user_id=$p['pengguna_id'];
							$user_nama=$p['pengguna_nama'];
							$this->m_album->update_album_tanpa_img($album_id,$user_id,$user_nama);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/album');
	            } 
