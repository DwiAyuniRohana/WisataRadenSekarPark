...
<head>
  ...
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/images/silat.jpg'?>">
  <!-- Bootstrap 3.3.6 -->
...
<?php 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 magang hore</a>.</strong> All rights reserved.
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Tambah</label>
                                        <div class="col-sm-7">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
                                ...
                                <input type="hidden" value="<?php echo $album_cover;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Upload foto</label>
                                        <div class="col-sm-7">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $album_id;?>"/> 
                     <input type="hidden" value="<?php echo $album_cover;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Gambar ini? <b></b> ?</p>
